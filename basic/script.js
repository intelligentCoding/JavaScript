...
var Kashif = {
    ...
    job: 'Programmer',
    isMarried: true,
    family: ['Yasir', 'Kinza', 'Ayeza'],
    calculateAge: function () {
        return 2018 - this.yearOfBirth;
    }
};

//console.log(Kashif.calculateAge(1970));
console.log(Kashif.calculateAge());

var age = Kashif.calculateAge();
Kashif.age = Kashif;
